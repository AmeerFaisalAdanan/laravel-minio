...
# Install extensions
RUN apt-get update && apt-get install -y libpq-dev && docker-php-ext-install pdo pdo_pgsql gd zip intl
...
#copy only apps directory to the container
COPY app/ /var/www/laravel
